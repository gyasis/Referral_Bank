...
def filter_by_specialty():
    ...
    # Convert the dataframe to HTML. Include classes for columns.
    html_table = results[['id', 'NAME_OF_ORGANIZATION', 'NAME', 'SPECIALTY']].to_html(index=False, classes={'id': 'hidden-id'})
    return html_table
