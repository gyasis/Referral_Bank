...
def sanitize_column_name(col_name):
    # Remove any character not a word character or a space
    sanitized = re.sub(r'[^\w\s]', '', col_name)
...
# %%
# list the names of the columns of the table of the database
...
# %%
# merge two columns into one LOCATION AND LOCATIONS  KEEPING VALUES OF FIRST COLUMN UNLESS VALUES ARE EMPTY THEN DEFEAULT TO SECOND COLUMN
curson.excute("SELECT LOCATION, LOCATIONS FROM referrals")