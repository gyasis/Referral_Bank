...
#drop duplicates after counting len before and after and alert ot how many duplicates were dropped
def drop_duplicates(df):
    print(f"Length of dataframe before dropping duplicates: {len(df)}")
...
#how many Nan in speciality
print(final_df['SPECIALTY'].isna().sum())
# %%
